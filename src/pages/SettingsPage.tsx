...
interface SettingsPageProps {
  ...
  onSettingsChange: (settings: DataFile['settings']) => void;
}
    ...
    return (
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="card text-center py-16">
          ...
          <p className="text-gray-500 mt-2">Please select a file from the Files page to configure settings</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Configure settings for: <span className="font-medium text-primary-600">{activeFile.name}</span></p>
      </div>
