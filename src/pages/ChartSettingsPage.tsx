...
import { PieChart, BarChart3, TrendingUp, Type, Axis3D, Hash } from 'lucide-react';
import { ColumnConfig, ChartSettings } from '../types';
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Customize how your data is visualized in charts</p>
      </div>
      ...
      {columns.length === 0 ? (
        <div className="card text-center py-16">
          ...
          <p className="text-gray-500 mt-2">Please upload an Excel file first to configure chart settings</p>
        </div>
      ) : (
              ...
              {chartTypes.map(({ value, label, icon: Icon, color }) => (
                ...
                >
                  <input
                    ...
                    onChange={(e) => onChartSettingsChange({ ...chartSettings, type: e.target.value as ChartSettings['type'] })}
                    className="sr-only"
                  />
            ...
            <div className="card">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-lg bg-cyan-100 flex items-center justify-center">
                  <Axis3D className="w-5 h-5 text-cyan-600" />
                </div>
                <div>
